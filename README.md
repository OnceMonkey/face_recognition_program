# face_recognition_program
 This is a simple face recognition program based on "ageitgey/face_recognition", some codes are heavily same,  This repository just for run right out of the box.
